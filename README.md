...
0.97 is a beta release for BepInEx 5 compatibility and center-screen interactions. Use 0.96c if you want the current stable release.
...
1. Download [ParaWASD-0.97-beta.zip](https://github.com/nolanlane/ParaWASD/releases/download/0.97/ParaWASD-0.97-beta.zip).
